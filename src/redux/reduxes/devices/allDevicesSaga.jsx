...
function* fetchAllDevices(action) {
  try {
    ...
    yield put({ type: "GET_ALL_DEVICES_SUCCESS", allDevices: res.data });
  } catch (e) {
    yield put({ type: "GET_ALL_DEVICES_FAILED", message: e.message });
  }
}

function* allDevicesSaga() {
  yield debounce(1000, "GET_ALL_DEVICES_REQUESTED", fetchAllDevices);
}

export default allDevicesSaga;
