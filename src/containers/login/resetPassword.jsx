    ...
    <>
      ...
      <header className="fixed flex items-center z-50 bg-white dark:bg-darkBg dark:border-b dark:border-black3 w-full h-[60px] px-8 py-2 shadow-md overflow-hidden">
        <div className="w-full  flex items-center">
          <div className="flex items-center min-w-[200px] max-w-[200px] h-[50px]">
            <Link
              to="/"
              exact={true}
              className="w-[200px] max-w-[200px] h-[50px] overflow-hidden"
            >
              <img
                src={logoDetails && logoDetails.org_logo}
                alt="organization-logo"
                className="min-w-[200px] max-w-[300px] min-h-[50px] h-full object-contain"
              />
            </Link>
          </div>
          ...
          <div className="flex items-center justify-end  ml-auto">
            <Link
              to="/login"
              exact={true}
              className="text-primary text-opacity-80 font-medium transition-all hover:text-opacity-100 hover:transition-all"
            >
              Back to Login
            </Link>
          </div>
