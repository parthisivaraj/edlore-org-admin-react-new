...
const DeleteTroubleshootStep = ({ head, body, deleteAction, modalAction, modalValue, id, model_id, step_id, trouble_id, deleteLoading }) => {
...
export default DeleteTroubleshootStep;