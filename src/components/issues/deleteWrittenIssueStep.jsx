...
const DeleteWrittenIssueStep = ({ head, body, deleteAction, modalAction, modalValue, id, model_id, section_id, step_id, wi_id, deleteLoading }) => {
...
export default DeleteWrittenIssueStep;